 ...
 *
 * Atualizações de estado de emissão: escritas **diretas** nesta fase; o relay
 * outbox (ADR-0003) será ligado na Fase 4 (workers) envolvendo estas chamadas.
 * O TODO marca onde o outbox-relay entrará.
 *
...
export class AtacadoRepository implements AtacadoPort {
	...
	async atualizarStatusFatura(id: number, status: import("#/domain/types").StatusFatura): Promise<void> {
		// TODO(Fase 4): rotear via outbox-relay. Hoje: escrita direta.
