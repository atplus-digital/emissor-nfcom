...
mock.module("@generators/io/atomic-writer", () => ({
...
mock.module("@generators/cli/flags", () => {
	...
	return {
		...
		setDiffDebug: (value: boolean) => {
			diffDebug = value;
		},
		isDiffDebug: () => diffDebug,
	};
});

import { isValidationSkipped, setDiffDebug } from "@generators/cli/flags";
...
} from "@generators/lifecycle/lifecycle-tasks";
